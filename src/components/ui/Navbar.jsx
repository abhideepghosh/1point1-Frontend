...
const Navbar = () => {
  ...
  return (
    <div className=" mb-32 bg-white fixed inset-x-0 top-0 z-50 border-b-2 border-gray-100 py-6 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10 place-items-center">
            <a
              href="#"
            ...
            <div className="relative">
              ...
              <button
                ...
                className="
                    ...
                    "
                onMouseEnter={() => (
                  setFlyer(!flyer), setFlyerTwo(false), setFlyerThree(false)
                )}
              >
                <span>Services</span>
                {/*
                ...
                <div
                  ...
                  className={
                    flyer
                      ...
                      : " opacity-0 translate-y-1 absolute -z-50 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                  }
                >
                  <div
                    className={
                      flyer
                        ? "z-10 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden"
                        : "-z-50 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden"
                    }
                  >
                    <div
                      className={
                        flyer
                          ? "z-50 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8"
                          : "-z-50 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8"
                      }
                    >
                      <a
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 place-items-center">
            <a
              href="#"
